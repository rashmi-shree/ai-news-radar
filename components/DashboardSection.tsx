...
const CARD_DEFS: (Omit<StatCardProps, "value"> & { key: keyof DashboardStats })[] = [
  ...
  },
  {
    key:       "criticalThreats",
    label:     "Hot Items",
    sublabel:  "build score ≥ 90",
    Icon:      ShieldAlert,
    iconBg:    "border-rose-500/30 bg-rose-950/60",
    iconColor: "text-rose-400",
    border:    "border-rose-500/20",
    glow:      "shadow-[0_0_28px_-6px_rgba(244,63,94,0.35)]",
    gradient:  "bg-gradient-to-br from-rose-950/40 via-zinc-900 to-zinc-900",

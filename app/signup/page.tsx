...
export default function SignupPage() {
  ...
  // ── Confirmed state (email verification required) ──────────────────────────
    ...
    return (
      <div className="flex min-h-screen flex-col items-center justify-center bg-zinc-950 px-4">
        <div className="w-full max-w-sm text-center">
          ...
          <h2 className="text-lg font-bold text-slate-100">Check your inbox</h2>
          ...
          <Link
            href="/login"
            className="mt-6 inline-block text-sm text-cyan-500 hover:text-cyan-400"
          >
            Back to sign in
          </Link>
        </div>
      ...
      <div className="w-full max-w-sm">
        ...
        <div className="mb-8 flex flex-col items-center gap-3">
          ...
          <div className="text-center">
            ...
            <p className="mt-1 text-sm text-zinc-500">Create your builder account</p>
          </div>
        </div>
        ...
        <div className="relative mb-4">
          ...
          <div className="relative flex justify-center">
            <span className="bg-zinc-950 px-3 text-xs text-zinc-600">or sign up with email</span>
          </div>
        </div>
